...
{
	/// <summary>
	/// <see cref="ConEmuHost" /> states.
	/// </summary>
	public enum States
	{
		/// <summary>
		///     <para>There has been no console emulator opened in this control yet.</para>
		///     <para>The control is now empty, and <see cref="ConEmuHost.RunningSession" /> is <c>NULL</c>. A new session can be started with <see cref="ConEmuHost.Start" />.</para>
		/// </summary>
		Unused = 0,

		/// <summary>
		///     <para>The console emulator is open, and the console process is running in it.</para>
		///     <para><see cref="ConEmuHost.RunningSession" /> is available. A new session cannot be started until the current session is closed (<see cref="ConEmuSession.CloseConsoleEmulator" />).</para>
		/// </summary>
		...
		///     <para>The control is now empty and not showing the console view, and <see cref="ConEmuHost.RunningSession" /> is <c>NULL</c>. A new session can be started with <see cref="ConEmuHost.Start" />.</para>
		/// </summary>
		Recycled = 3
	}
}