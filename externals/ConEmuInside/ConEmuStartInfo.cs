	...
	public sealed class ConEmuStartInfo
	{
		...
		public XmlDocument BaseConfiguration
		{
			get
			{
				...
				xmldoc.Load(typeof(ConEmuStartInfo).Assembly.GetManifestResourceStream("ConEmu.Inside.ConEmu.xml")!);
		...
		///     <para>The default is <see cref="Inside.WhenConsoleProcessExits.KeepConsoleEmulatorAndShowMessage" />.</para>
		///     <para>This property cannot be changed when the process is running.</para>
		/// </summary>
