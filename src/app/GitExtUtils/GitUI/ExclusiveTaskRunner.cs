...
public class ExclusiveTaskRunner : IDisposable
{
    ...
    /// <summary>
    /// Exclusivly run <paramref name="asyncAction"/> asynchronously on the current thread and forward all exceptions to <c>TaskManager.UnhandledExceptionHandler</c> except for <c>OperationCanceledException</c>, which is ignored.
