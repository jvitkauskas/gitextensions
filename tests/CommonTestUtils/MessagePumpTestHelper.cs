...
/// <summary>
///  Helpers for the tests that need to pump messages on the UI thread.
/// </summary>
public static class MessagePumpTestHelper
{
    // Same delay as RevisionDataGridView.BackgroundThreadUpdatePeriod
    private const int _processDelayMilliseconds = 25;

    /// <summary>
    ///  Pumps the messages in a loop until <paramref name="condition"/> returns <see langword="true"/>,
    ...
    /// <summary>
    ///  Pumps the messages for at least <paramref name="milliseconds"/> milliseconds.
    /// </summary>
