...
public sealed class NormalizeFileNameTests
{
    ...
    [TestCase(@"path\file.ext", "path/file.ext", IncludePlatform = "Win")]
    [TestCase(@"path/file.ext", "path/file.ext")]
    [TestCase(@"c:\path\file.ext", "c:/path/file.ext", IncludePlatform = "Win")]
    [TestCase(@"c:\path/file.ext", "c:/path/file.ext", IncludePlatform = "Win")]
    [TestCase(@"c:/path/file.ext", "c:/path/file.ext")]
    [TestCase(@"c:\working\dir\path\file.ext", "path/file.ext", IncludePlatform = "Win")]
    [TestCase(@"c:/working/dir/path/file.ext", "path/file.ext", IncludePlatform = "Win")]
    [TestCase(@"C:\working\dir\path\file.ext", "C:/working/dir/path/file.ext", IncludePlatform = "Win")]
